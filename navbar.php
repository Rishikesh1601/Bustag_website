...
<body>
    <div class="sidenav" id="sidenavbar">
        <img src="images/logo1.png" class="sidenavlink" id="logo">
        <a id="index" class="sidenavlink nav-index" href="index.php"><img src="images/vec_dashboard.png" class="nav-icon">Dashboard</a>
        <a id="live" class="sidenavlink" href="live.php"><img src="images/vec_live.svg" class="nav-icon">Track Bus</a>
        <a id="schedule" class="sidenavlink nav-myplan" href="schedule.php"><img src="images/vec_diet_plan.svg" class="nav-icon">Bus Schedule</a>
        <a id="payments" class="sidenavlink nav-payments" href="payment.php"><img src="images/vec_payments.svg" class="nav-icon">Payments</a>
        <a id="buspass" class="sidenavlink" href="pass.php"><img src="images/vec_recipies.svg" class="nav-icon">BusTag Pass</a>
        <a id="aboutus" class="sidenavlink" href="aboutus.php"><img src="images/vec_health_form.svg" class="nav-icon">About Us</a>
    ...
    <div class="topnav">
        <div class="topnav-content" id="topnav-change">
            <p id="topnav-content-1">Welcome, <span id="topnav-content-1-name">
                <strong>
                    <?php

                     $id11 = $_SESSION['name'] ;
                    $sql1 = "SELECT name FROM users WHERE name ='$id11'";
                    $res = mysqli_query($conn,$sql1);
                    $row = mysqli_fetch_assoc($res) ; 
                    echo $row['name'];
                    ?>
                </strong></span></p>
            <p id="topnav-content-2">Explore public transport on your finger tips</p>
        </div>
    ...
    <div class="mobile-menu">
        <div id="mySidenav" class="sidenavv">
            ...
            <a href="live.php"><img src="images/vec_live.png">&nbsp&nbsp Track Bus</a>
            <a href="schedule.php"><img src="images/vec_recipies.png">&nbsp&nbsp Bus Schedule</a>
            <a href="payment.php"><img src="images/vec_mail.png">&nbsp&nbsp Payments</a>
            <a href="pass.php"><img src="images/vec_recipies.png">&nbsp&nbsp BusTag Pass</a>
            <a href="aboutus.php"><img src="images/vec_recipies.png">&nbsp&nbsp About Us</a>
