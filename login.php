                ...
                <div class="form_inputs login-area">
                   ...
                   ?>
                        ...
                        <div class="ip_box">
                            ...
                            <input class="input_bar" id="email" type="text" name="username"
                                placeholder="Username">
                        </div>
                        <div class="ip_box">
                            <img src="images/shield.svg" alt="">
                            <input type="text" name="password" class="input_bar" id="password" 
                                placeholder="Password">
                                <!-- <img src="images/eye.png" alt="" style="position: relative;left: -43px;cursor:pointer;"> -->
                        </div>
                        <!-- <br> -->
